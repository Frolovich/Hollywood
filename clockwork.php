...
<body>
    ...
    <div class="container-fluid">
        <h1 style="text-align:center;">Orange mécanique</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/clockwork.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/clockwork.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/clockwork.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/clockwork.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Dans un monde du futur, un chef de gang sadique est emprisonné et se porte volontaire pour une expérience, mais tout ne se passe pas comme prévu.                    <br>
                    <strong> Acteur principal :     Malcolm McDowell Patrick Magee Michael Bates</strong>
                    </div>
                </div>
            </div>
