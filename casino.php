    ...
    <div class="container-fluid">
        <h1 style="text-align:center;">Casino</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/casino.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/casino.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/casino.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/casino.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Une histoire d'avidité, de tromperie, d'argent, de pouvoir et de meurtre se produit entre deux meilleurs amis: un agent de la mafia et un dirigeant de casino s'affrontent/entrent en compétition à cause d'un empire du jeu et d'une jeune femme mondaine à la vie trépidante.                    <br>
                    <strong> Acteur principal :  Robert De Niro Sharon Stone Joe Pesci </strong>
                    </div>
                </div>
            </div>
            <div class="glide" style="margin-top:450px;">
                <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides">
                        ...
                        <li class="glide__slide" style="text-align:center;"><a href="reservoir.php"><img src="filmsforsite/reservoir.jpg" width="200px;" style="border-radius: 10px"></a></li>
                    </ul>
                </div>
