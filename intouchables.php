...
<body>
    ...
    <div class="container-fluid">
        <h1 style="text-align:center;">Intouchables</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/intouchables.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/intouchables.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/intouchables.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/intouchables.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Après être devenu tétraplégique à la suite d'un accident de parapente, un aristocrate engage un jeune homme des cités en tant qu'aide-soignant.                    <br>
                    <strong> Acteur principal : François Cluzet Omar Sy Anne Le Ny </strong>
                    </div>
                </div>
            </div>
