    ...
    <div class="container-fluid">
        <h1 style="text-align:center;">Les affranchis</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/goodfellas.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/goodfellas.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/goodfellas.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/goodfellas.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    L'histoire d'Henry Hill et de sa vie dans la mafia, couvrant ses relations avec son épouse Karen Hill et ses partenaires de la mafia Jimmy Conway et Tommy DeVito dans le syndicat du crime italo-américain.                    <br>
                    <strong> Acteur principal :     Robert De Niro Ray Liotta Joe Pesci</strong>
                    </div>
                </div>
            </div>
