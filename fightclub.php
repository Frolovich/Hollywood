    ...
    <div class="container-fluid">
        <h1 style="text-align:center;">Fight Club</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/fightclub.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/fightclub.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/fightclub.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/fightclub.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Un employé de bureau insomniaque et un fabriquant de savons forment un club de combat clandestin qui devient beaucoup plus que ça.                    <br>
                    <strong>Acteur principal :     Brad Pitt Edward Norton Meat Loaf</strong>
                    </div>
                </div>
            </div>
