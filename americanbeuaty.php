    ...
    <div class="container-fluid">
        <h1 style="text-align:center;">American Beauty</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/americanbeuaty.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/americanbeuaty.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/americanbeuaty.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/americanbeuaty.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Un père de banlieue sexuellement frustré entre en pleine crise de la quarantaine après s'être épris de la meilleure amie de sa fille.
                    <br>
                    <strong> Acteur principal : Kevin Spacey Annette Bening Thora Birch</strong>
                    </div>
                </div>
            </div>
