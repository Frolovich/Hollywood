    ...
    <div class="container-fluid">
        <h1 style="text-align:center;">Reservoir Dogs</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="filmsforsite/reservoir.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/reservoir.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/reservoir.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="filmsforsite/reservoir.jpg" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Un chef de la mafia réunit une équipe de six criminels expérimentés dans le but de réaliser un grand braquage de bijouterie.                    <br>
                    <strong> Acteur principal :     Harvey Keitel Tim Roth Michael Madsen </strong>
                    </div>
                </div>
            </div>
